...
def test_explode_pair():
    ...
    num7 = [[[[6, 8], [6, [6, 6]]], [[0, 13], [31, 0]]], [[16, [6, 6]], [15, [14, 0]]]]
    num8 = [[[9, [5, 6]], [[8, 8], [0, 9]]], [[[9, [5, 6]], 15], [[8, 3], 8]]]
    ...
    assert explode_pair(num7, '[6, 6]', 15) == [[[[6, 8], [12, 0]], [[6, 13], [31, 0]]], [[16, [6, 6]], [15, [14, 0]]]]
    assert explode_pair(num8, '[5, 6]', 40) == [[[9, [5, 6]], [[8, 8], [0, 9]]], [[[14, 0], 21], [[8, 3], 8]]]
